        ...
        while (i < 10) {
            ...
            buttons[j].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // Model
                    // Log.v("Input n°"+countingInputs, " // Valeur actuelle : "+numbers.get(countingInputs)+" // Valeur choisie : "+buttonValue+" // Valeur stockée : "+numbers.get(countingInputs)+""+buttonValue);
        ...
        while (i < 14) {
            ...
            buttons[j].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    numbers.add("");
                    countingInputs++;
                    Log.v("Old input : "+numbers.get(countingInputs-1)+" // New input : "+numbers.get(countingInputs), "");


                    //Log.v("TEST", "Opérand "+buttonValue+" / "+"Input n°"+countingInputs);
